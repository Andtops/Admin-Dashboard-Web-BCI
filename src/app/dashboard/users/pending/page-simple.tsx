...
export default function PendingUsersPageSimple() {
    ...
    try {
      ...
      try {
        ...
        if (emailData.success) {
          toast.success("User approved successfully and email sent via Gmail API");
          console.log('✅ Gmail API email sent:', emailData);
        } else {
  ...
  const handleRejectUser = async (userId: string) => {
    ...
    try {
      ...
      try {
        ...
        if (emailData.success) {
          toast.success("User rejected successfully and email sent via Gmail API");
          console.log('✅ Gmail API email sent:', emailData);
        } else {
